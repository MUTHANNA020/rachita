        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtraVitalsJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VitalSigns_Prescriptions_PrescriptionId",
                        column: x => x.PrescriptionId,
                        principalTable: "Prescriptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SyncAuditLogs_Timestamp",
                table: "SyncAuditLogs",
                column: "Timestamp");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VitalSigns_PrescriptionId",
                table: "VitalSigns",
                column: "PrescriptionId",
                unique: true);
        }
